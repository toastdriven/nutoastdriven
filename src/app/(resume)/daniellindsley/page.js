  ...
  return (
    <div className="vcard">
      ...
      <div className="contact_info">
        ...
        <div className="email">
          <a href="mailto:daniel@toastdriven.com">daniel@toastdriven.com</a>
        </div>
...
function About(props) {
  return (
    <>
      <h2>
        <a name="about-link">About</a>
      </h2>

      <p>
        I&apos;m a developer specializing in web-based technologies. I&apos;m a
        pretty full-stack kinda guy, comfy with everything from database schema
      ...
      <p>
        Outside of work, I love working on open-source, playing video games,
        playing/composing music, reading, snowboarding, &amp; bicycling.
      </p>
    </>
  );
}
        ...
        {professionalSkills.map((skillInfo, offset) => (
          <dd key={offset}>
            <a
              href={skillInfo.url}
              className={
                highlightedSkills.indexOf(skillInfo.name) >= 0
                  ? "highlighted-skill"
                  : ""
              }
            >
...
function Experience({
  ...
  return (
    ...
    >
      {allowCollapsed && (
        <div className="align-top print:hidden">
          <Disclosure collapsed={collapsed} setCollapsed={setCollapsed} />
        </div>
      )}
      {!collapsed ? (
        <div>
        ...
        <div className="flex flex-row flex-wrap leading-4">
...
function Portfolio(props) {
  return (
    <>
      <h2>
        <a name="portfolio-link">Open-Source &amp; Community</a>
      </h2>
      ...
      <div className="flex flex-row flex-wrap gap-2">
        <div className="piece">
          ...
          <p>
            ...
            <br />
            Haystack acts as a search layer for Django, similar to the Django
            ORM. Nice API &amp; lots of functionality.
          </p>
        </div>
        ...
        <div className="piece">
          ...
          <p>
            <strong>Primary author</strong>
            <br />
            Tastypie is a library that adds RESTful APIs to your Django
            application. Full-featured &amp; designed to be easily extended.
          </p>
        </div>
        ...
        <div className="piece">
          ...
          <h3>
            <a href="http://djangodash.com/">Django Dash</a>
          </h3>

          <p>
            <strong>Organizer</strong>
            <br />
            The Django Dash is an annual 48-hour programming competition for
            Django. Teams of up to three compete for bragging rights &amp;
            prizes. Run from 2008&mdash;2014.
          </p>
        </div>
        ...
        <div className="piece">
          ...
          <h3>
            <a href="http://wsgiwrestle.com/">WSGI Wrestle</a>
          </h3>

          <p>
            <strong>Organizer</strong>
            <br />
            The WSGI Wrestle is an annual 48-hour programming competition,
            similar to the Django Dash but for all Python programmers. Run once
            in 2014.
          </p>
        </div>
      </div>
    ...
    <div className="container">
      <div className="md:flex md:flex-row print:flex print:flex-row">
        <div className="md:w-96 print:w-96 md:relative">
          ...
          <section id="skills">
            <Skills highlightedSkills={highlightedSkills} />
          </section>

          <div className="mini-divider md:hidden">&nbsp;</div>

          <section className="portfolio md:hidden print:visible">
            <Portfolio />
          </section>
        ...
        <div className="md:grow md:ml-8 print:grow print:ml-8">
          ...
          <section id="experience">
            <h2>
              <a name="experience-link">Experience</a>
            </h2>
            ...
            >
              A wide variety of backend & frontend projects, including adding
              deep white-label support, modernizing/updating tools & build
              processes. Heavily revised configuration & UI for self-serve.
              Improved workout/scoring processes & UI. Testing & documentation
              improvements.
            </Experience>
            ...
            >
              ...
              updated a service based on a security review. Mentored several
              junior engineers, held interviews for other senior engineers, &
              many (~360) code reviews.
            </Experience>
            ...
            <Experience
              ...
              setHighlightedSkills={setHighlightedSkills}
            >
              Developed a Django API backend & React frontend for a
              white-labeled small business application. Upgraded a learning
              platform&apos;s Django backend & React frontend through several
              major framework versions of each.
            </Experience>
            ...
            <Experience
              ...
              skillsUsed={["Python", "Django", "Docker", "PostgreSQL"]}
              setHighlightedSkills={setHighlightedSkills}
            >
              ...
              internal technical planning documents for pending projects. Worked
              on improving a bulk import system using Django Rest Framework.
            </Experience>
            ...
            <Experience
              ...
              setHighlightedSkills={setHighlightedSkills}
            >
              Built a web-based mapping tool & scientific platform to support
              wildfire firefighting, using Django / PostGIS / GDAL / OpenLayers.
              Implemented several scientific whitepapers from scratch to compute
              potential control locations & suppression difficulty index, as
            ...
            <Experience
              ...
              endDate="01/2020"
              jobTitle="Software Engineer"
              skillsUsed={["Python", "Docker", "PostgreSQL"]}
              setHighlightedSkills={setHighlightedSkills}
            >
              Rebuilt the development environment used by all Gen2 developers,
              based on Docker & Compose. Rewrote the bootstrapping process for
              new environments in Python, cutting new setup time from days down
              to 20 minutes. Provided user support & 8 releases for a community
              of ~150 developers. Ad-hoc managed a team of 4 for several months.
              Helped improve performance, security & test coverage.
            </Experience>
            ...
            >
              Worked on the{" "}
              <a href="https://go.urbanairship.com/">Urban Airship</a> user
              interface in Django & pure Javascript, including several major
              features around timezones, third-party integrations, PostgreSQL
              data migrations, and a team-based permission system. Performed
              many code reviews, established internal documentation/procedures
            ...
            <Experience
              ...
              skillsUsed={["Python", "PostgreSQL", "AWS"]}
              setHighlightedSkills={setHighlightedSkills}
            >
              Worked on <a href="http://docs.pythonboto.org/">boto</a> for
              Python, including adding a high-level interface for DynamoDB(2),
              approximately a dozen releases &amp; many service updates. Also
              developed the initial code for{" "}
              <a href="https://github.com/toastdriven/boto3">boto3</a>.
              Conducted a number of interviews, many code reviews &amp; time
              mentoring.
            </Experience>
            ...
            <Experience
              ...
              allowCollapsed={true}
            >
              Ran my own Python/Django consultancy. Originally just me, we had
              as many as three people. Helped many clients with their RESTful
              APIs, integrating search in Elasticsearch & Solr, as well as
              general development.
            </Experience>
            ...
            <Experience
              ...
              endDate="05/2008"
              jobTitle="Owner"
              skillsUsed={["Ruby", "Ruby on Rails", "MySQL", "HTML", "CSS"]}
              setHighlightedSkills={setHighlightedSkills}
              allowCollapsed={true}
            >
              Run as a Ruby on Rails shop for short period of time. Worked on a
              reporting site (using Flex, Actionscript &amp; Rails) to produce
              nice charts/graphs for surveying software.
            </Experience>
            ...
            <Experience
              ...
              allowCollapsed={true}
            >
              Did PHP/MySQL development for a variety of clients. Tasks included
              developing on multi-lingual CMSes, several e-commerce sites,
              hosting &amp; server administration, &amp; the development of a
              PHP5 web framework called Acorn. Also some Rails development for a
              client.
            </Experience>
            ...
            <Experience
              ...
              allowCollapsed={true}
            >
              Developed a e-sales application for a Fortune 500 sales team using
              PHP/MySQL &amp; a custom PHP5 framework similar to Sinatra/Rails.
            </Experience>
          ...
          <section className="portfolio md:visible print:hidden">
            <Portfolio />
          </section>
      ...
      <footer>
        ...
        <div className="italic">References available upon request.</div>
